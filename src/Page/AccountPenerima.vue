      ...
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        >
          <tr>
            ...
            <th scope="col" class="px-6 py-3 uppercase">penghasilan perbulan</th>
            <th scope="col" class="px-6 py-3 uppercase">jumlah tanggungan</th>
            <th scope="col" class="px-6 py-3 uppercase">jumlah kendaraan</th>
            <th scope="col" class="px-6 py-3 uppercase">status tempat tinggal</th>
            <th scope="col" class="px-6 py-3 uppercase">jenis kebutuhan</th>
            <th scope="col" class="px-6 py-3 uppercase">nama barang</th>
            <!-- <th scope="col" class="px-6 py-3 uppercase">jumlah</th> -->
